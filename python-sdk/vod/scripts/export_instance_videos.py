...
"""
Generate videos of VOD object instances.
See https://github.com/EricWiener/vod-instance-videos for more detailed instructions.
...
def get_cropped_image_for_annotation(sample_data_annotation: dict,
    ...
    :param sample_data_annotation: Dict of form:
      ...
      'visibility_token': '4'},
      ```
    :param dataroot: The VOD dataroot.
...
def main(version: str,
         ...
         codec: str) -> None:
    """
    Generates video sequences of VOD object instances over time.
    ...
    :param version: The VOD data version.
    ...
    # You can use the sample_annotation_token with the VOD helper in order to get the sample tokens.
