...
def export_scene_pointcloud(nusc: VOD,
                            out_path: str,
                            scene_token: str,
...
def pointcloud_color_from_image(nusc: VOD,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_dir', default='~/vod-visualization/pointclouds', type=str, help='Output folder')
