...
"""
Exports the VOD ego poses as "GPS" coordinates (lat/lon) for each scene into JSON or KML formatted files.
"""
...
def get_poses(nusc: VOD, scene_token: str) -> List[dict]:
    """
...
def derive_latlon(location: str, poses: List[Dict[str, float]]) -> List[Dict[str, float]]:
    ...
    :param poses: All VOD egopose dictionaries of a scene.
...
def main(dataroot: str, version: str, output_prefix: str, output_format: str = 'kml') -> None:
    ...
    :param dataroot: Path of the VOD dataset.
    ...
    """
    # Init VOD.
    nusc = VOD(dataroot=dataroot, version=version, verbose=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='/data/sets/vod', help="Path where VOD is saved.")
