...
from vod.eval.detection.constants import DETECTION_NAMES
from vod.eval.detection.evaluate import DetectionEval
from vod.eval.detection.utils import category_to_detection_name, detection_name_to_rel_attributes
