...
from vod.eval.detection.data_classes import DetectionConfig


def config_factory(configuration_name: str) -> DetectionConfig:
    """
    Creates a DetectionConfig instance that can be used to initialize a VODEval instance.
    Note that this only works if the config file is located in the vod/eval/detection/configs folder.
