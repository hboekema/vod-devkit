...
from vod.eval.common.render import setup_axis
from vod.eval.common.utils import boxes_to_sensor
from vod.eval.detection.constants import TP_METRICS, DETECTION_NAMES, DETECTION_COLORS, TP_METRICS_UNITS, \
    PRETTY_DETECTION_NAMES, PRETTY_TP_METRICS
from vod.eval.detection.data_classes import DetectionMetrics, DetectionMetricData, DetectionMetricDataList
from vod.utils.data_classes import LidarPointCloud
from vod.utils.geometry_utils import view_points

Axis = Any


def visualize_sample(nusc: VOD,
                     sample_token: str,
                     gt_boxes: EvalBoxes,
    ...
    :param nusc: VOD object.
    :param sample_token: The VOD sample token.
...
def detailed_results_table_tex(metrics_path: str, output_path: str) -> None:
    ...
    tex += 'VOD Detection Score (NDS) = {:.1f} \n'.format(metrics['nd_score'] * 100)
    tex += '}\n'
