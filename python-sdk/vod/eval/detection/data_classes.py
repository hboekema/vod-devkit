...
from vod.eval.common.data_classes import MetricData, EvalBox
from vod.eval.common.utils import center_distance
from vod.eval.detection.constants import DETECTION_NAMES, ATTRIBUTE_NAMES, TP_METRICS
...
class DetectionMetrics:
    ...
    def nd_score(self) -> float:
        """
        Compute the VOD detection score (NDS, weighted sum of the individual scores).
        :return: The NDS.
        """
        # Summarize.
