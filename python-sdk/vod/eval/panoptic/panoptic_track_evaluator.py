...
class PanopticTrackingEval(PanopticEval):
    ...
    def __init__(self,
        ...
        :param min_stuff_cls_id: Minimum stuff class index, 11 for Panoptic VOD challenge classes.
    ...
    def add_batch_panoptic(self,
        ...
        # Make sure instance IDs are non-zeros. Otherwise, they will be ignored. Note in Panoptic VOD,
