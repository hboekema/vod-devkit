"""
Script to generate Panoptic VOD predictions from nuScene-lidarseg predictions and VOD-tracking or
VOD-detection predictions.
...
from vod.eval.common.loaders import load_prediction, add_center_dist
from vod.eval.common.utils import boxes_to_sensor
from vod.eval.detection.data_classes import DetectionBox
from vod.eval.lidarseg.utils import get_samples_in_eval_set
from vod.eval.panoptic.utils import PanopticClassMapper
from vod.eval.tracking.data_classes import TrackingBox
from vod.vod import VOD
from vod.utils.data_classes import LidarSegPointCloud
from vod.utils.geometry_utils import points_in_box
...
def generate_panoptic_labels(nusc: VOD,
                             ...
                             verbose: bool = False):
    """
    Generate VOD lidar panoptic predictions.
    :param nusc: A instance of VOD.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Generate panoptic from VOD-LiDAR segmentation and tracking results.')
    ...
    out_dir = args.out_dir if args.out_dir is not None else f'VOD-panoptictrack-merged-prediction-{args.version}'
