"""
Script to generate baselines for Panoptic VOD tasks.
...
from vod.eval.panoptic.evaluate import VODPanopticEval
from vod.eval.panoptic.get_panoptic_from_seg_det_or_track import generate_panoptic_labels
...
def panop_baselines_from_lidarseg_detect_track(out_dir: str,
    ...
    :param task: The task to create the panoptic predictions for and run evaluation on (either tracking or
        segmentation).
    :param version: Version of VOD to use (e.g. "v1.0", ...).
    :param dataroot: Path to the tables and data for the specified version of VOD.
...
def generate_and_evaluate_baseline(out_dir: str,
    ...
    :param verbose: Whether to print messages to stdout.
    """
    nusc = VOD(version=version, dataroot=dataroot, verbose=verbose)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--version', type=str, default='v1.0-test',
                        help='Version of VOD to use (e.g. "v1.0", ...).')
    parser.add_argument('--dataroot', type=str, default='/data/sets/vod',
                        help='Path to the tables and data for the specified version of VOD.')
