...
from vod import VOD
from vod.eval.lidarseg.utils import LidarsegClassMapper, get_samples_in_eval_set
from vod.utils.data_classes import LidarPointCloud


def validate_submission(nusc: VOD,
                        results_folder: str,
                        eval_set: str,
                        verbose: bool = False,
    ...
    - Check that the submission folder is according to that described in
      https://github.com/nutonomy/vod-devkit/blob/master/python-sdk/vod/eval/lidarseg/README.md
