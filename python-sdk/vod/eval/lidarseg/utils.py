...
class LidarsegClassMapper:
    """
    Maps the (fine) classes in VOD-lidarseg to the (coarse) classes for the VOD-lidarseg challenge.

    Example usage::
        nusc_ = VOD(version='v1.0-mini', dataroot='/data/sets/vod', verbose=True)
    ...
    def get_stats(self, points_label: np.array) -> List[int]:
        ...
        # of classes in VOD-lidarseg and lidarseg challenge.
...
def get_samples_in_eval_set(nusc: VOD, eval_set: str) -> List[str]:
    """
