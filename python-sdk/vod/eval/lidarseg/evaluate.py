...
from vod import VOD
from vod.eval.lidarseg.utils import ConfusionMatrix, LidarsegClassMapper, get_samples_in_eval_set
from vod.utils.data_io import load_bin_file


class LidarSegEval:
    """
    This is the official VOD-lidarseg evaluation code.
    Results are written to the provided output_dir.

    VOD-lidarseg uses the following metrics:
    ...
    Please see https://www.vod.org/lidar-segmentation for more details.
    """
    def __init__(self,
                 nusc: VOD,
                 results_folder: str,
    ...
    def evaluate(self) -> Dict:
        ...
        if self.verbose:
            print("======\nVOD-lidarseg evaluation for {}".format(self.eval_set))
...
if __name__ == '__main__':
    # Settings.
    parser = argparse.ArgumentParser(description='Evaluate VOD-lidarseg results.')
    ...
    nusc_ = VOD(version=version_, dataroot=dataroot_, verbose=verbose_)
