...
""" Script for computing metrics for a submission to the vod prediction challenge. """
import argparse
import json
...
from vod import VOD
from vod.eval.prediction.config import PredictionConfig, load_prediction_config
