...
""" Implementation of metrics used in the VOD prediction challenge. """
import abc
...
from vod.prediction.input_representation.static_layers import load_all_maps
...
class OffRoadRate(Metric):
    ...
    def load_drivable_area_masks(helper: PredictHelper) -> Dict[str, np.ndarray]:
        ...
        maps: Dict[str, VODMap] = load_all_maps(helper)
