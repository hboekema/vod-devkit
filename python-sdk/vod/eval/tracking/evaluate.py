...
from vod import VOD
from vod.eval.common.config import config_factory
from vod.eval.common.loaders import load_prediction, load_gt, add_center_dist, filter_eval_boxes
from vod.eval.tracking.algo import TrackingEvaluation
from vod.eval.tracking.constants import AVG_METRIC_MAP, MOT_METRIC_MAP, LEGACY_METRICS
from vod.eval.tracking.data_classes import TrackingMetrics, TrackingMetricDataList, TrackingConfig, TrackingBox, \
    TrackingMetricData
from vod.eval.tracking.loaders import create_tracks
from vod.eval.tracking.render import recall_metric_curve, summary_plot
from vod.eval.tracking.utils import print_final_metrics


class TrackingEval:
    """
    This is the official VOD tracking evaluation code.
    ...
    Please see https://www.vod.org/tracking for more details.
    """
    def __init__(self,
        ...
        :param result_path: Path of the VOD JSON result file.
        :param eval_set: The dataset split to evaluate on, e.g. train, val or test.
        :param output_dir: Folder to save plots and results to.
        :param nusc_version: The version of the VOD dataset.
        :param nusc_dataroot: Path of the VOD dataset on disk.
        ...
        # Initialize VOD object.
        # We do not store it in self to let garbage collection take care of it and save memory.
        nusc = VOD(version=nusc_version, verbose=verbose, dataroot=nusc_dataroot)

        # Load data.
        if verbose:
            print('Initializing VOD tracking evaluation')
...
if __name__ == "__main__":
    ...
    # Settings.
    parser = argparse.ArgumentParser(description='Evaluate VOD tracking results.',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('result_path', type=str, help='The submission as a JSON file.')
    parser.add_argument('--output_dir', type=str, default='~/vod-metrics',
