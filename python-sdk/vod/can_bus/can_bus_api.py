...
class VODCanBus:
    """
    This class encapsulates the files of the VOD CAN bus expansion set.
    ...
    def __init__(self,
        ...
        """
        Initialize the VOD CAN bus API.
        :param dataroot: The VOD directory where the "can" folder is located.
        ...
        if not os.path.isdir(self.can_dir):
            raise Exception('Error: CAN bus directory not found: %s. Please download it from '
                            'https://www.vod.org/download' % self.can_dir)
...
if __name__ == '__main__':
    ...
    nusc_can = VODCanBus(dataroot=args.dataroot)
