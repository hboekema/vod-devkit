...
from vod.prediction import PredictHelper, convert_global_coords_to_local
...
class MockVOD(VOD):
    ...
    def __init__(self,
        ...
        """
        Mocks the VOD API needed to test PredictHelper.
        Note that we are skipping the call to the super class constructor on purpose to avoid loading the tables.
        :param sample_annotations: The sample_annotations table used in this fake version of VOD.
        :param samples: The sample table used in this fake version of VOD.
        """
