...
from vod.prediction.input_representation.static_layers import StaticLayerRasterizer
from vod.prediction.models.backbone import ResNetBackbone
from vod.prediction.models.mtp import MTP, MTPLoss
...
if __name__ == "__main__":
    ...
    nusc = VOD('v1.0-trainval', dataroot=args.data_root)
