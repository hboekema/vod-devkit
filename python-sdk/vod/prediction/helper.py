# VOD dev-kit, based on the VOD dev-kit.
from typing import Any, Callable, Dict, List, Tuple, Union

import numpy as np
from pyquaternion import Quaternion
from vod import VOD
from vod.eval.common.utils import angle_diff, quaternion_yaw
...
class PredictHelper:
    """Wrapper class around VOD to help retrieve data for the prediction task."""

    def __init__(self, vod: VOD):
        """
        Inits PredictHelper
        :param vod: Instance of VOD class.
        """
        self.data = vod
    ...
    def _iterate(
        ...
        while (
            time_elapsed <= seconds_with_buffer and len(annotations) < max_annotations
        ):
