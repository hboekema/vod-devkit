...
from vod.prediction.input_representation.static_layers import StaticLayerRasterizer, draw_lanes_on_image


class TestStaticLayerRasterizer(unittest.TestCase):

    PATH = 'vod.prediction.input_representation.static_layers.{}'
    ...
    def test_make_rasterization(self, mock_draw_lanes, mock_load_maps):
        ...
        by get_map_mask method of VOD map API.
        """
