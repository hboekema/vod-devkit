...
# Since VOD 2.0 the requirements are stored in separate files.
...
setuptools.setup(
    ...
    author='Holger Caesar, Oscar Beijbom, Qiang Xu, Varun Bankiti, Alex H. Lang, Sourabh Vora, Venice Erin Liong, '
           ...
           'et al.',
    author_email='vod@motional.com',
    description='The official devkit of the VOD dataset (www.vod.org).',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/nutonomy/vod-devkit',
    python_requires='>=3.6',
